...
define([
	 ...
	 *
	 * @alias CustomTileMapServiceImageryProvider
	 * @constructor
	 *
	 ...
	 * var tms = new Cesium.CustomTileMapServiceImageryProvider({
     ...
     * });
	 */
	var CustomTileMapServiceImageryProvider = function CustomTileMapServiceImageryProvider(options) {
		...
		this._url = url;
		this._urlBuilder = defaultValue(options.urlBuilder, buildImageUrl);
		this._ready = false;
		...
		var tryLoadXML = defaultValue(options.loadXML, true);
		if(!tryLoadXML) {
			loadDefaults();
		} else {
	...
	defineProperties(CustomTileMapServiceImageryProvider.prototype, {
		/**
		 * Gets the URL of the service hosting the imagery.
		 * @memberof CustomTileMapServiceImageryProvider.prototype
		 * @type {String}
		 */
		url : {
			get : function() {
		 ...
		 * not be called before {@link CustomTileMapServiceImageryProvider#ready} returns true.
		 * @memberof CustomTileMapServiceImageryProvider.prototype
		 * @type {Number}
		 */
		tileWidth : {
		 ...
		 * the source of the imagery.  This function should not be called before {@link CustomTileMapServiceImageryProvider#ready} returns true.
		 * @memberof CustomTileMapServiceImageryProvider.prototype
		 * @type {Credit}
		 */
		credit : {
	 ...
	 */
	CustomTileMapServiceImageryProvider.prototype.getTileCredits = function(x, y, level) {
		return undefined;
	};
	 ...
	 */
	CustomTileMapServiceImageryProvider.prototype.requestImage = function(x, y, level) {
		//>>includeStart('debug', pragmas.debug);
		if (!this._ready) {
		...
		var url = this._urlBuilder(this, x, y, level);
		return ImageryProvider.loadImage(this, url);
	};

	return CustomTileMapServiceImageryProvider;
});
